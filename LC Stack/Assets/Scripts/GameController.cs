...
public class GameController : MonoBehaviour
{
    ...
    void Newblock()
    {
        if (lastCube != null)
        {
            ...
            //Current cubes positions equals to the current cubes x position last cubes y position z axis position of 0.5
        ...
        //Last cube equals current cube
        lastCube = currentCube;
        //Current cube equals to the spawned last cube
        currentCube = Instantiate(lastCube);
        //Current cube's name equals to the level number
        currentCube.name = Level + " ";
        //Current cube componenet mesh renderer material; set the color according to the color settings
        ...
        GameObject.Find("Main Camera").transform.LookAt(currentCube.transform.position);
    }
