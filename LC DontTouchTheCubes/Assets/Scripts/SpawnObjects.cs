...
public class SpawnObjects : MonoBehaviour
{
    ...
    void Update()
    {
        //The next cube to spawn will be based on the difficulty and game speed
        spawn = difficulty * Time.deltaTime;
        //Difficulty of the game is based off speed of the game times 4
        difficulty = Time.deltaTime * 4f;
        //While loop for spawning cubes if the spawn time is greater than 0
        while (spawn > 0)
        {
            //Spawn time minus 1
            spawn -= 1;
