...
public class PlayerControls : MonoBehaviour
{
    ...
    //movement difetion of the object
    ...
    void Update()
    {
        ...
        //if difection on x axis is greater than 0
        else
        {
        ...
        //If players velocity is greater than 0 and position on the y axis is greater than the score
    ...
    void FixedUpdate()
    {
        ...
        //equals to the velocity of t he rigidbody2D
        Vector2 velocity = rb.velocity;
        //Velocity of the x axis equals to
        //the direction movement on the x axis of the character.
        velocity.x = movement;
